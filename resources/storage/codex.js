        ...
        content: [
          {
            ...
            content: `§:break§§/@var.CHARCOLOR(player)/&generateCharacterSheet('player')&@var.+characters.player.name§ is an average commoner from the midlands. 10 years ago, §/red/&GetCodexEntity('Characters','Enemies','Viktor Stahlhelm')&Viktor Stahlhelm§ raided his hometown and kidnapped his little sister. Since then, MC has been thirsty for revenge. As soon as he turned 18, he and two of his friends left home in search of §/blue/&GetCodexEntity('Characters','Other characters','Erika')&Erika§.`,
            tags: [
              { tag: "party" },
          ...
          },
          {
            ...
            content: `§:break§§/@var.CHARCOLOR(player)/&generateCharacterSheet('player')&@var.CHARNAME(player)§’s childhood friend, who he does not have any romantic feelings toward. §&generateCharacterSheet('christina_healer')&Christina§ is a healer, but can cast a more powerful offensive spell.`,
            tags: [
              { tag: "party" },
