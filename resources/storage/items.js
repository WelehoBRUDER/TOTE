...
const items = [
  new Weapon("broken_iron_sword", "Broken Iron Sword", 10, 1, "broken_iron_sword_12", 1, 1, false, [{ type: "slash", value: 4 }, { type: "thrust", value: 1 }], -1),
  ...
  new Armor("magical_chestplate", "Magical Chestplate", 500, 5, "rusty_iron_ring_13", 1, 8, "chest", {slash: 40, blunt: 50, thrust: 20, fire: 20, frost: 40, wind: 40, water: 40, shock: 50, light: 50, dark: 50}, 3, [new Effect("inc_str_5", "str", "increase", 5), new Effect("inc_hp_125", "hp", "increase", 125), new Effect("inc_mp_150", "mana", "increase", 150)])
];