...
class Shield extends Equipment {
  constructor(key, name, price, level, img, amount, grade, slot, armor, speed, effects, imgEq, blockChance) {
    super(key, name, price, level, img, amount, grade),
      this.slot = slot,
      this.armor = armor,
      this.speed = speed,
...
const items = [
  ...
  new Shield("broken_iron_shield", "Broken Iron Shield", 10, 1, "items/broken_iron_shield_1", 1, 1, "shield", { slash: 52, blunt: 49, thrust: 50, fire: 26, frost: 17, wind: 61, water: 39, shock: 11, light: 15, dark: 14 }, -1, undefined, undefined, 13),
