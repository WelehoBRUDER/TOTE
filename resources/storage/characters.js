...
var characters = {
  player: new Player("warrior",
    ...
    [
      new Weapon("basic_iron_sword_0", "Rusty Iron Sword", 45, 0, "rusty_iron_sword_1", 1, false, [{ type: "slash", value: 5 }, { type: "thrust", value: 2 }], -1),
      ...
      new Armor("broken_iron_shield_0", "Rusty Iron Shield", 35, 1, "rusty_iron_shield_1", 1, "shield", { slash: 9, blunt: 8, thrust: 8, fire: 6, frost: 5, wind: 5, water: 7, shock: 2, light: 4, dark: 4 }, -1),
    ]),
  allies: [
...
characters.player.inventory = [
  new Weapon("broken_iron_sword_0", "Broken Iron Sword", 30, 1, "broken_iron_sword_1", 1, false, [{ type: "slash", value: 4 }, { type: "thrust", value: 1 }], -1),
  new Armor("broken_iron_shield_0", "Broken Iron Shield", 20, 1, "broken_iron_shield_1", 1, "shield", { slash: 7, blunt: 6, thrust: 6, fire: 4, frost: 4, wind: 4, water: 4, shock: 1, light: 3, dark: 3 }, -1),
